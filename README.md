...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 win32-x64 node-v20.15.0
...
_See code: [src/commands/hello/index.ts](https://github.com/alcabon/mynewcli/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/alcabon/mynewcli/blob/v0.0.0/src/commands/hello/world.ts)_
